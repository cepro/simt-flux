...
func TestDynamicPeakApproach(test *testing.T) {
	...
	subTests := []subTest{
		...
		},
		{
			...
			bessSoe:                  0.0,
			imbalanceVolume:          -100,
			expectedControlComponent: chargingControlComponentThatAllowsMoreCharge("dynamic_peak_approach", -375),
		},
		{
			...
			bessSoe:                  0.0,
			imbalanceVolume:          -100,
			expectedControlComponent: chargingControlComponentThatAllowsMoreCharge("dynamic_peak_approach", -1125.0),
		},
		{
			...
			bessSoe:                  0.0,
			imbalanceVolume:          100,
			expectedControlComponent: chargingControlComponentThatAllowsMoreCharge("dynamic_peak_approach", -750.0),
		},
		{
		...
		},
		{
			...
			bessSoe:                  200,
			imbalanceVolume:          -100,
			expectedControlComponent: chargingControlComponentThatAllowsMoreCharge("dynamic_peak_approach", -1275.0),
		},
	}
