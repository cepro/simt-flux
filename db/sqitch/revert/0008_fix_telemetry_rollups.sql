-- Revert flux:0008_fix_telemetry_rollups from pg

BEGIN;

-- This reverts the get_meter_readings_5m and get_meter_readings_30m functions so that they incorrectly reference the flows schema
